...
#+begin_src bash :exports results :results output ansi :wrap src bash
source ~/.bashrc
ctree . 
#+end_src
...
#+begin_src bash
[1;34m.[0m
├── [1;34mcommunication/[0m # handle transfer or data
├── [1;34mdata/[0m
...
│   └── vote_resp.py
├── [1;34mfunctions/[0m
│   ├── [1;34mn-ary/[0m # i.e. if forall X, then do Y
│   │   ├── _candidate.py
│   │   ├── _follower.py
│   │   ├── _leader.py
│   │   └── server.py
│   └── [1;34munary/[0m # for handling messages
│       ├── append_entries_req.py
